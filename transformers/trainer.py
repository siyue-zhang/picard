    ...
    def evaluation_loop(
        ...
        for step, inputs in enumerate(dataloader):
            ...
            if 'squall_meta' in inputs:
                squall_meta = inputs['squall_meta']
            # Prediction step
            loss, logits, labels = self.prediction_step(model, inputs, prediction_loss_only, ignore_keys=ignore_keys, squall_meta=squall_meta)
